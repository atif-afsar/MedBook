...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
      ...
      <p className='sm:w-1/3 text-center text-sm'>Simply browse through our extensive list of doctors, choose your preferred one, and book your appointment easily.</p>
